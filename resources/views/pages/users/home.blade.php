...
@section('content')
    ...
    <section class="text-center flex">
        ...
        <div class="w-1/2 h-screen ">
            <img class="w-full h-full object-cover" src="{{ asset('images/bannercoffe.jpg') }}" alt="">
    ...
    <section class=" bg-[#422424] p-24">
        ...
        <div class="grid md:grid-cols-3 gap-8 text-[#e6dbd1]">
            <div class="p-6 bg-[#523433] rounded-lg flex justify-center items-center flex-col gap-4">
                ...
                <h4 class="text-xl font-bold mb-4">Hand Roasted</h4>
            </div>
            <div class="p-6 bg-[#523433] rounded-lg flex justify-center items-center flex-col gap-4">
                ...
                <h4 class="text-xl font-bold mb-4">Organic Coffee</h4>
            </div>
            <div class="p-6 bg-[#523433] rounded-lg flex justify-center items-center flex-col gap-4">
                ...
                <h4 class="text-xl font-bold mb-4">Direct Coffee</h4>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md text-left text-[#3e1f1f] relative">
                <div class="p-4 w-full h-72">
                    <span class="absolute top-2  left-4 bg-[#5e3c3c] text-white px-2 py-1 text-xs rounded">100%
                        Aribika</span>
                    <img src="{{ asset('images/coffe.png') }}" alt="Product 1" class="w-full h-full scale-110 object-cover">
                </div>
                <div class="bg-[#eee3d2] p-4">
                    ...
                    <div class="flex justify-between items-center ">
                        ...
                        <button class="bg-[#3e1f1f] hover:bg-[#5a2d2d] text-white text-xs px-3 py-1 rounded transition">ADD
                            TO
                            CART</button>
                    </div>
                </div>
