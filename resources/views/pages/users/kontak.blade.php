        ...
        <div class="w-full max-w-7xl   mx-auto mt-10">
            <div class="w-full flex flex-col items-center gap-10">
                <div class="text-center">
                    ...
                    <h2 class="text-4xl font-bold font-manrope leading-normal text-slate-950">Layanan Pelanggan Terra Shop</h2>
                    
                    <p class="text-gray-500 text-base font-normal leading-relaxed mt-4">
                        Jika Anda memiliki pertanyaan atau membutuhkan bantuan, jangan ragu untuk menghubungi kami melalui informasi di bawah ini.
                    </p>
                </div>
                        ...
                        <div class="bg-linen p-6  flex items-center gap-6 hover:shadow-lg transition">
                            <a href="https://wa.me/6285242271149" target="_blank" class="flex items-center gap-6">
                                <div class="p-4 bg-blue-100 rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-slate-950" fill="none" viewBox="0 0 24 24" stroke="currentColor">
