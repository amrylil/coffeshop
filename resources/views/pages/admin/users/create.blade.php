                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" name="name_222297" id="name_222297"
                                ...
                                value="{{ old('name_222297') }}" required>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="email" name="email_222297" id="email_222297"
                                class="mt-1 p-2 focus:ring-[#6F4E37] focus:border-[#6F4E37] block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                value="{{ old('email_222297') }}" required>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <select name="role_222297" id="role_222297"
                                ...
                                <option value="customer" {{ old('role_222297') == 'customer' ? 'selected' : '' }}>Customer
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <select name="gender_222297" id="gender_222297"
                                ...
                                <option value="male" {{ old('gender_222297') == 'male' ? 'selected' : '' }}>Male</option>
                                <option value="female" {{ old('gender_222297') == 'female' ? 'selected' : '' }}>Female
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea name="address_222297" id="address_222297" rows="3"
                                class="mt-1 p-2 focus:ring-[#6F4E37] focus:border-[#6F4E37] block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('address_222297') }}</textarea>
                        </div>
