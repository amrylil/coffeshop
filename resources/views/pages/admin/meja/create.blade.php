...
@section('content')
    <div class="bg-white min-h-screen py-8 px-4 sm:px-6 lg:px-8 pt-20">
        <div class="max-w-4xl mx-auto">
            <!-- Header Section -->
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-[#6F4E37]">Add New Meja</h1>
                <p class="mt-2 text-sm text-gray-500">Create a new meja for your coffee shop</p>
            </div>

            <!-- Form Section -->
            <div class="bg-white shadow overflow-hidden rounded-lg">
                <form action="{{ route('admin.meja.store') }}" method="POST" class="p-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1">
                            <label for="nomor_meja_222297" class="block text-sm font-medium text-[#6F4E37]">Nomor Meja
                                (optional)</label>
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="number" name="kapasitas_222297" id="kapasitas_222297" min="1"
                                class="mt-1 p-2 focus:ring-[#6F4E37] focus:border-[#6F4E37] block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                value="{{ old('kapasitas_222297') }}" required>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" name="status_222297" id="status_222297"
                                class="mt-1 p-2 focus:ring-[#6F4E37] focus:border-[#6F4E37] block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                value="{{ old('status_222297') }}" required>
                        </div>
                    </div>
